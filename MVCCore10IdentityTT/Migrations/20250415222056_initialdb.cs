        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarkaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MarkaAd = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Araclar_AspNetUsers_UyeId",
                        column: x => x.UyeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "58e82f1a-0bee-4aa5-8d71-7ae010286a34", "Admin", "ADMIN" },
                    { 2, "179aa875-463a-4b7c-8a9c-4a199db9ba9c", "Uye", "UYE" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "Tugce", "Bursa, Turkey", "129f05c6-6932-4422-a0fc-3a1c161fa6ba", "ttorun@hotmail.com", false, false, null, "TTORUN@HOTMAIL.COM", "TUGCETORUN", null, null, false, "c0c5a3cc-61f1-4853-9a4d-d488705f614d", "Torun", false, "tugcetorun" });

            migrationBuilder.InsertData(
                table: "Markalar",
                columns: new[] { "MarkaId", "MarkaAd" },
                values: new object[,]
                {
                    { 1, "BMW" },
                    { 2, "Mercedes" },
