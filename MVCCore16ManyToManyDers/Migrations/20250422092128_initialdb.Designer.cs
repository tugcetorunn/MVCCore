...
namespace MVCCore16ManyToManyDers.Migrations
{
    ...
    [Migration("20250422092128_initialdb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCCore16ManyToManyDers.Models.Kitap", b =>
                {
            ...
            modelBuilder.Entity("MVCCore16ManyToManyDers.Models.KitapYazar", b =>
                {
                    b.Property<int>("KitapId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCCore16ManyToManyDers.Models.Yazar", b =>
                {
                    b.Property<int>("YazarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCCore16ManyToManyDers.Models.KitapYazar", b =>
                {
                    b.HasOne("MVCCore16ManyToManyDers.Models.Kitap", "Kitap")
                        .WithMany("Yazarlar")
                        .HasForeignKey("KitapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVCCore16ManyToManyDers.Models.Yazar", "Yazar")
                        .WithMany("Kitaplar")
